...
const WHATSAPP_URL = 'https://wa.me/551533845087'
const MAPS_URL = 'https://maps.app.goo.gl/JvtxjriS2nhXnvBX8'
  ...
  return (
    <header className="header">
      <div className="header-inner">
        {/* Logo */}
        <Link href="/" className="logo" aria-label="Ana Modas - Página inicial">
          <Image
            src="/logo.png"
            alt="Ana Modas"
            width={150}
        ...
        <div className="header-actions">
          ...
          <a
            ...
            aria-label="Ver localização da loja no Google Maps"
            title="Como chegar"
          >
            <MapPin size={20} />
          </a>
          ...
          >
            ...
            <span className="whatsapp-label">Falar</span>
          </a>

          {/* Carrinho */}
          <Link href="/carrinho" className="cart-btn" aria-label="Ver carrinho">
            <ShoppingBag size={22} />
            {totalItens() > 0 && (
